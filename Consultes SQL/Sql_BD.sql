...
/* Creamos la tabla tb_movie_person */
CREATE TABLE movies.tb_movie_person (
  ...
  CONSTRAINT fk_movper_movie FOREIGN KEY (movie_id) REFERENCES movies.tb_movie (movie_id) ON DELETE CASCADE,
